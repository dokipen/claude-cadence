...
<!-- Tool Assignment Rationale:
     - read_file, glob, Grep: Navigate and search code for review
...
1. read_file `CLAUDE.md` for verification commands and project conventions
...
3. read_file modified files in full context
